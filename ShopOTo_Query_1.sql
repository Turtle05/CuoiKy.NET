...
('C300','Sedan','C',N'Đen',5,N'Xăng',1939000000,N'Mercedes-benz C300.Chiều dài cơ sở: 4686 (mm).Dung tích xi lanh: 1991 (cc).Dung tích bình nhiên liệu: 66 (litre)',10);
insert into car
values ('EQS','Sedan','E',N'Trắng',5,N'Điện',2399000000,N'Mercedes-benz EQS.Chiều dài cơ sở: 5265 (mm).Phạm vi hoạt động: 770 (km)',10),
...
('S600','Sedan','S',N'Đen',5,N'Xăng',14448000000,N'Mercedes-benz Maybach S600.Chiều dài cơ sở: 5453 (mm).Dung tích xi lanh: 5980 (cc).Dung tích bình nhiên liệu: 80 (litre)',10),
('S680','Sedan','S',N'Đỏ Rubellite',5,N'Xăng',18500000000,N'Mercedes-benz Maybach S680.Chiều dài cơ sở: 5468 (mm).Dung tích xi lanh: 1991 (cc).Dung tích bình nhiên liệu: 66 (litre)',10),
('S65','Sedan','S',N'Đen',5,N'Xăng',12800000000,N'Mercedes-benz Maybach S65.Chiều dài cơ sở: 5287 (mm).Dung tích xi lanh: 5980 (cc).Dung tích bình nhiên liệu: 80 (litre)',10),
...
('AMG-GT2','Coupe','AMG-GT',N'Xanh',2,N'Xăng',4050000000,N'Mercedes-benz AMG-GT.Chiều dài cơ sở: 4544 (mm).Dung tích xi lanh: 2999 (cc).Dung tích bình nhiên liệu: 90 (litre)',10),
('AMG-GT4','Coupe','AMG-GT',N'Xanh',4,N'Xăng',6719000000,N'Mercedes-benz AMG-GT.Chiều dài cơ sở: 4874 (mm).Dung tích xi lanh: 3982 (cc).Dung tích bình nhiên liệu: 100 (litre)',10),
('AMG-C43','Coupe','AMG-C',N'Đen',2,N'Xăng',4150000000,N'Mercedes-benz AMG C43.Chiều dài cơ sở: 4669 (mm).Dung tích xi lanh: 2996 (cc).Dung tích bình nhiên liệu: 66 (litre)',10),
('AMG-C63','Coupe','AMG-C',N'Trắng',2,N'Xăng',4678000000,N'Mercedes-benz AMG C63.Chiều dài cơ sở: 4757 (mm).Dung tích xi lanh: 3982 (cc).Dung tích bình nhiên liệu: 66 (litre)',10),
...
create procedure Car_Details
@car_name varchar(255)
as
select car_name, cartype, car_class, car_seat, energy_type, color, car_info
from car where car_name = @car_name
